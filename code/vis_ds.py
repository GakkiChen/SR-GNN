...
class SRDataset(Dataset):
	...
	def __getitem__(self, index):
		...
		for pairs in self.relationships[index]:
			...
			node_dict[src_idx] = box1
			node_dict[tgt_idx] = box2
